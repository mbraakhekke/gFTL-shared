...
# GEOS Debug
# ----------
set (CMAKE_Fortran_Debug_Flags "-O0 -g -Kieee -Minfo=all -Mbounds ${TRACEBACK} -Mchkfpstk -Mchkstk -Mdepchk")
set (CMAKE_Fortran_Debug_FPE_Flags "${common_Fortran_fpe_flags}")

# GEOS Release
# ------------
set (CMAKE_Fortran_Release_Flags "-fast -Kieee -g")
set (CMAKE_Fortran_Release_FPE_Flags "${common_Fortran_fpe_flags}")
